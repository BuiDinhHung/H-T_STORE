    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0 col-md-10 justify-content-center">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu bg-light">
                ...
                <li> <a class="nav-link  " href="./shop-keyboard.html">Bàn phím</a></li>
                <li><a class="nav-link" href="./shop-mouse.html">Chuột</a></li>
                <li><a class="nav-link" href="./eror.html">Tai nghe</a></li>
            </ul>
        </li>
        <li class="nav-item">
            <a class="nav-link position-relative" href="#">Thương hiệu</a>
            <ul class="sub-menu bg-light">
                <li><a class="nav-link" data-brand = 'acer'  href="./shop-brand.html">ACER</a></li>
                <li><a class="nav-link" data-brand = 'asus' href="./shop-brand.html">ASUS</a></li>
                <li><a class="nav-link" data-brand = 'corsair' href="./shop-brand.html">CORSAIR</a></li>
                <li><a class="nav-link" data-brand = 'logitech' href="./shop-brand.html">LOGITECH</a></li>
                <li><a class="nav-link" data-brand = 'msi' href="./shop-brand.html">MSI</a></li>
                <li><a class="nav-link" data-brand = 'razer' href="./shop-brand.html">RAZER</a></li>
            </ul>
        </li>
        <li class="nav-item">
...
<div class="row justify-content-center">
    <div class="col-md-3">
        ...
        <p class="text-capitalize mt-3">Trang cung cấp và phân phối các sản phẩm gaming gear hàng đầu Việt Nam - Cao Cấp Chính Hãng 100%.</p>
    </div>
    <div class="col-md-2">
        <h3>Thông tin</h3>
...
<footer>
    <p class="text-center m-0">Copyright © 2023 | Tất cả bản quyền thuộc về <b>Phạm Huy Hiếu</b> & <b>Nguyễn Thành Trung</b> </p>
</footer>
</div>
`
    //push code search
